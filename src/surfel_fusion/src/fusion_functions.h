...
#define SP_SIZE 8         //很关键 设置过小，地图分辨率高，但是实时性降低 设置为8 ，实时性非常好
#define MAX_ANGLE_COS 0.1  
// for drive
#define HUBER_RANGE 0.4   //range
#define BASELINE 0.5     //baseline 
#define DISPARITY_ERROR 4.0  //disparity
#define MIN_TOLERATE_DIFF 0.1  //tolerate
// for RGBD
